...
export default function FooterSection({ lang }: { lang: Lang }) {
  const groups = [
    ...
    {
      title: tr(lang, "Participate"),
      links: [
        {
          href: `/${lang}/support`,
          label: l(lang, "Donate", "Faire un don", "Spenden", "Spenden"),
        },
        {
    ...
    {
      title: tr(lang, "Trust and openness"),
      links: [
        {
          href: `/${lang}/privacy`,
          label: l(
        ...
        { href: "https://github.com/clarvia-org/clarvia-graph", label: "GitHub", external: true },
        {
          ...
          label: tr(lang, "Governance / review policy"),
          external: true,
        },
      ],
    },
