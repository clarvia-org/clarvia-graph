...
const META: Record<Lang, { title: string; description: string }> = {
  en: {
    ...
    description:
      "Clarvia is a Luxembourg non-profit building a free, multilingual bereavement guide for families after the loss of a loved one. Every contribution, however small, makes that guidance more accurate, accessible, and trustworthy.",
  },
  fr: {
      ...
      >
        ...
        >
          {l(
            ...
            "Hëlleft Clarvia, Familljen ze hëllefen",
          )}
        </h1>
        ...
        <p className="text-sm font-medium text-calm-blue-500 mb-12 text-center">
          {l(
            ...
            "Kee Programméierwëssen néideg. All Bäiträg si wëllkomm.",
          )}
        </p>
