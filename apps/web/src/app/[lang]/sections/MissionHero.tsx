  ...
  return (
    <section className="text-center py-12 sm:py-16">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6">
        <Link href={`/${lang}#ask-us`} className="btn-primary px-8 py-3 text-base min-h-11 inline-flex items-center">
          {s1("Ask Clarvia")}
        </Link>
        <Link href={`/${lang}/guidance`} className="btn-secondary px-8 py-3 text-base min-h-11 inline-flex items-center">
          {s1("Read published guidance")}
        </Link>
      </div>
      <p className="text-sm text-calm-blue-500">{s1("Free · No account · Reply by email · Available worldwide")}</p>
    </section>
  );
}
