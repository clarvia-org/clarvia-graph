        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-calm-blue-100/50">
          ...
          <div>
            ...
            <p>
              {l(
                lang,
                "We collect records needed to process donations. See our Privacy Policy for how we handle family questions.",
                "Nous collectons les données nécessaires au traitement des dons. Consultez notre politique de confidentialité pour savoir comment nous traitons les questions des familles.",
                "Wir erfassen Daten für die Abwicklung von Spenden. Wie wir Fragen von Familien behandeln, steht in unserer Datenschutzerklärung.",
                "Mir sammele Donnéeë fir d'Veraarbechtung vun Donen. Wéi mir d'Froe vu Famillje behandelen, steet an eiser Dateschutzerklärung."
              )}
            </p>
          </div>
