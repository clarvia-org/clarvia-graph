    ...
    sections: [
        ...
        table: {
          ...
          rows: [
            [
              "_ga",
              "Google Analytics",
              "Distinguishes users for website analytics.",
              "Up to 2 years",
            ],
            [
              "_ga_K67M5B4932",
            ...
            [
              ...
              "Helps measure advertising and donation conversions.",
              "Up to 3 months",
            ],
            [
              "_gcl_aw",
              "Google Ads",
              "Stores Google ad click information for conversion attribution.",
              "Up to 90 days",
            ],
          ],
        },
      ...
      },
      {
        ...
        body: [
          ...
          "If you believe your data is handled incorrectly, you have the right to lodge a complaint with Luxembourg's data protection authority, the Commission nationale pour la protection des données (CNPD).",
        ],
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "_ga",
              "Google Analytics",
              "Distingue les utilisateurs à des fins d’analyse du site.",
              "Jusqu’à 2 ans",
            ],
            [
              "_ga_K67M5B4932",
              "Google Analytics",
              "Conserve l’état de session pour l’analyse.",
              "Jusqu’à 2 ans",
            ],
            [
              "_gcl_au",
              "Google Ads / Google Tag",
              "Aide à mesurer les conversions publicitaires et les dons.",
              "Jusqu’à 3 mois",
            ],
            [
              "_gcl_aw",
              "Google Ads",
              "Stocke les informations de clic publicitaire Google pour l’attribution des conversions.",
              "Jusqu’à 90 jours",
            ],
          ],
        },
        ...
        table: {
          ...
          rows: [
            [
              "_ga",
              "Google Analytics",
              "Unterscheidet Nutzer für Website-Analysen.",
              "Bis zu 2 Jahre",
            ],
            [
              "_ga_K67M5B4932",
              "Google Analytics",
              "Speichert den Sitzungsstatus für Analysen.",
              "Bis zu 2 Jahre",
            ],
            [
              "_gcl_au",
              "Google Ads / Google Tag",
              "Hilft bei der Messung von Werbung und Spenden-Conversions.",
              "Bis zu 3 Monate",
            ],
            [
              "_gcl_aw",
              "Google Ads",
              "Speichert Informationen zu Google-Anzeigenklicks für die Conversion-Zuordnung.",
              "Bis zu 90 Tage",
            ],
          ],
        },
